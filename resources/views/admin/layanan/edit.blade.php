            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h2 class="text-white fw-bold m-0" style="font-size: 1.75rem;"><i
                            class="bi bi-pencil-square me-2"></i>Edit Layanan</h2>
                    <p class="text-white-50 m-0 mt-2">Perbarui informasi layanan dan harga servis</p>
                </div>
                        ...
                        <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_layanan" name="nama_layanan" value="{{ old('nama_layanan', $layanan->nama_layanan) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="harga" name="harga" value="{{ old('harga', $layanan->harga) }}" placeholder="0" required
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                    ...
                                    style="border-radius: 10px;">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
                                ...
                                <button type="submit" class="btn btn-modern btn-lg px-5 save-confirm" data-message="Simpan perubahan data layanan ini?">Update Layanan</button>
                            </div>
                        </form>
                    </div>
                </div>
