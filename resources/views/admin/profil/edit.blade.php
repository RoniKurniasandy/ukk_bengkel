...
<div class="container py-4">
    <div class="edit-header text-center text-white mb-5">
        <h3 class="fw-bold mb-1">Pengaturan Akun Admin</h3>
        <p class="opacity-75 mb-0">Kelola informasi identitas dan keamanan akun administrator</p>
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-lg rounded-4 glass-card mb-4 overflow-hidden">
                <div class="card-header bg-white py-3 border-bottom d-flex align-items-center">
                    <div class="bg-dark bg-opacity-10 p-2 rounded-3 me-3">
                        <i class="bi bi-person-badge-fill text-dark fs-5"></i>
                    </div>
                    <h6 class="fw-bold text-dark mb-0">Identitas Administrator</h6>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.profil.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="position-relative d-inline-block">
                                    ...
                                    @else
                                        ...
                                        <img src="" id="profile-preview" class="rounded-circle border border-4 border-white shadow d-none" 
                                             style="width: 120px; height: 120px; object-fit: cover;">
                                    @endif
                                    <label for="foto" class="position-absolute bottom-0 end-0 bg-dark text-white rounded-circle p-2 shadow" style="cursor: pointer; transform: translate(5px, 5px);">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top text-start">
                            <a href="{{ route('admin.profil.index') }}" class="btn btn-link text-muted text-decoration-none">
                                <i class="bi bi-arrow-left me-1"></i> Batal
                            </a>
                            <button type="submit" class="btn btn-dark px-5 rounded-pill shadow save-confirm" data-message="Perbarui data profil admin Anda?">
                                <i class="bi bi-save me-2"></i> Update Profil Admin
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 glass-card overflow-hidden">
                <div class="card-header bg-white py-3 border-bottom d-flex align-items-center">
                    ...
                    <h6 class="fw-bold text-dark mb-0">Keamanan & Password</h6>
                </div>
                <div class="card-body p-4 text-start">
                    <form action="{{ route('admin.profil.password') }}" method="POST">
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-outline-danger px-4 rounded-pill save-confirm" data-message="Anda yakin ingin mengubah password akun Anda?">
