        ...
        <div class="col-lg-4">
                    ...
                    <div class="position-relative d-inline-block mb-3">
                        ...
                        @else
                            ...
                            <img src="" id="profile-preview" class="rounded-circle border border-4 border-white shadow d-none" 
                                 style="width: 120px; height: 120px; object-fit: cover;">
                        @endif
                        <label for="foto-input" class="position-absolute bottom-0 end-0 bg-success text-white rounded-circle p-2 shadow-sm" style="cursor: pointer; transform: translate(5px, 5px);">
                            <i class="bi bi-camera-fill"></i>
                        </label>
                    </div>
                    
                    <h5 class="fw-bold mb-1">{{ $user->nama }}</h5>
                    <p class="text-muted small mb-3"><i class="bi bi-tools me-1"></i> Staff Mekanik</p>
            ...
            <div class="card border-0 shadow-sm glass-card rounded-4">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3">Detail Akun</h6>
                    <div class="mb-3">
                        <label class="text-muted small d-block">ID Mekanik</label>
                        <span class="fw-medium">#MK-{{ str_pad($user->id, 4, '0', STR_PAD_LEFT) }}</span>
                    </div>
                    <div class="mb-0">
        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm rounded-4 glass-card mb-4">
                <div class="card-header bg-white py-3 border-bottom">
                    <h6 class="fw-bold text-success mb-0"><i class="bi bi-pencil-square me-2"></i> Pengaturan Biodata Mekanik</h6>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('mekanik.profil.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 text-start">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-muted small fw-bold text-uppercase">Nomor WhatsApp</label>
            ...
            <div class="card border-0 shadow-sm rounded-4 glass-card">
                <div class="card-header bg-white py-3 border-bottom">
                    <h6 class="fw-bold text-danger mb-0"><i class="bi bi-key-fill me-2"></i> Ganti Password</h6>
                </div>
                <div class="card-body p-4">
